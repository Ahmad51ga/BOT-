...
module.exports.run = async function({ api, event, Threads }) {
	...
	return api.sendMessage(`ممنوع حذف الرسائل ${(data["resend"] == true) ? "تم تشغيله" : "تم ايقافه"} بنجاح!`, threadID, messageID);
}